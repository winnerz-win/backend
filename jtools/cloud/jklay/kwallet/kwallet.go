...
func (my Wallet) PrivateKeyECDSA() *ecdsa.PrivateKey {
	privatekey, _ := crypto.HexToECDSA(my.PrivateKey())
	return privatekey
}
...
func (my Wallet) CommonAddress() common.Address {
	return common.HexToAddress(my.Address())
}
