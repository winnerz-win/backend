...
func (my MessagePrefix) String() string { return string(my) }

const (
	MESSAGE_PREFIX_METAMASK = MessagePrefix("\u0019Ethereum Signed Message:\n")
	MESSAGE_PREFIX_KLAYTN   = MessagePrefix("\u0019Klaytn Signed Message:\n")
)
...
func debugBuffer(b []byte) {
	//cc.Purple("<debug>", "0x"+hex.EncodeToString(b))
}
