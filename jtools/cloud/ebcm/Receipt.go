...
type TxReceipt struct {
	...
	Type   *TxType `bson:"type,omitempty" json:"type,omitempty"`     //klay
...
func (my TxReceipt) Success() bool {
	if !my.IsNotFound {
		return !my.IsError()
	}
	return false
...
func (my TxReceipt) TxFeeWEI() string {
	gas_price := my.EffectiveGasPrice
	return jmath.MUL(
		my.GasUsed,
		gas_price,
	)
...
func (my TxReceipt) TxFeeETH() string {
	return WeiToETH(my.TxFeeWEI())
}
