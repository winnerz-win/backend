...
func (my *Doc) ResultOK(kvlist ...keyValue) *Doc {
	my.Result(chttp.StatusOK, kvlist...)
	return my
}
...
func (my *Doc) ResultBadParameter(tag ...string) *Doc {
	my.Result(chttp.StatusBadRequest, KV("message", `"Bad-parameter"`, tag...))
	return my
}

// ResultBadRequest :
func (my *Doc) ResultBadRequest(tag ...string) *Doc {
	my.Result(chttp.StatusBadRequest, KVMessageString(tag...))
	return my
}

// ResultUnauthorized :
func (my *Doc) ResultUnauthorized(tag ...string) *Doc {
	my.Result(chttp.StatusUnauthorized, KVMessageString(tag...))
	return my
}

// ResultServerError :
func (my *Doc) ResultServerError(tag ...string) *Doc {
	my.Result(chttp.StatusInternalServerError, KVMessageString(tag...))
	return my
}

// ResultNotFound :
func (my *Doc) ResultNotFound(tag ...string) *Doc {
	my.Result(chttp.StatusNotFound, KVMessageString(tag...))
	return my
}

// ResultConflict :
func (my *Doc) ResultConflict(tag ...string) *Doc {
	my.Result(chttp.StatusConflict, KVMessageString(tag...))
	return my
}
