...
import (
	...
	"strconv"
	"strings"
	"txscheduler/brix/tools/database/mongo/tools/jmath/decimal"
)
...
func (my bigNumber) Int64() int64   { return int64(my.BigInt().Uint64()) }
func (my bigNumber) Int() int       { return int(my.BigInt().Uint64()) }
