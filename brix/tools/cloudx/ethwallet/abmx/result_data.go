...
// func (my *ResultItemList) add(n string, val interface{}) {
// 	item := ResultItem{
// 		Name: n,
// 		Data: val,
// 	}
...
// func (my *RESULT) addItem(n string, val interface{}) {
// 	my.items.add(n, val)
// }

// type RESULT ebcmx.RESULT
type RESULT struct {
	abix.RESULT
}

// func (my RESULT) Address(i int) string {
// 	return ebcmx.RESULT(my).Address(i)
// }

func newResultArgs(rts abiReturns) RESULT {
	my := RESULT{
		RESULT: abix.RESULT{},
	}
	return my
