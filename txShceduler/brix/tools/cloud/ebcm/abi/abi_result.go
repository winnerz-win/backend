...
func (my ResultItem) Tuple() TupleList { return my.Data.(TupleList) }
...
type IRESULT interface {
	...
	Tuple(i int) TupleList
	TupleOne(i int) ResultItemList
}
...
func (my ResultItemList) Tuple(i int) TupleList         { return my[i].Tuple() }
func (my ResultItemList) TupleOne(i int) ResultItemList { return my[i].Tuple()[0] }
