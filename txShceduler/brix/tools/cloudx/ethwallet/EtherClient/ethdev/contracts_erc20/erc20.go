...
import (
	...
	//"github.com/ethereum/go-ethereum/accounts/abi/kjserr"	//ETHKJS
...
// NewContractABI : shera10004
func NewContractABI(address common.Address, backend bind.ContractBackend, abiString string) (*Token, error) {
	contract, err := bindContractABI(address, backend, backend, backend, abiString)
	if err != nil {
		return nil, err
	}
	return &Token{TokenCaller: TokenCaller{contract: contract}, TokenTransactor: TokenTransactor{contract: contract}, TokenFilterer: TokenFilterer{contract: contract}}, nil
...
// bindContractABI : shera10004
func bindContractABI(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer, abiString string) (*bind.BoundContract, error) {
...
// // Call2 : kjs  ETHKJS
// func (_Token *TokenCallerRaw) Call2(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) kjserr.Call2Error {
// 	return _Token.Contract.contract.Call2(opts, result, method, params...)
// }

// // TupleDummy : kjs ETHKJS
// func (_Token *TokenCallerRaw) TupleDummy() *[]interface{} {
// 	return &[]interface{}{}
// }
...
func (_Token *TokenCaller) BalanceOf(opts *bind.CallOpts, tokenOwner common.Address) (*big.Int, error) {
	...
	result := &[]interface{}{}
	err := _Token.contract.Call(opts, result, "balanceOf", tokenOwner)
...
func (_Token *TokenCaller) KJSCall(
	opts *bind.CallOpts,
	result *[]interface{},
	method string,
	params ...interface{}) error {

	return _Token.contract.Call(
		opts,
		result,
		method,
		params...,
